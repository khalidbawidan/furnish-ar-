...
window.translations = {
  ar: {
    ...
    "culture_heading": "تراثنا هويّتنا",
    "culture_body": "تزخر الجزيرة العربية بإرث حضاري عريق يمتد لآلاف السنين. هذه القطع ليست مجرد أدوات، بل هي رموز حيّة تحكي قصة الإنسان السعودي: كرمه، شجاعته، وارتباطه العميق بأرضه. من خلال هذه الجولة، ستستكشف أربع قطع أثرية بالواقع المعزّز وتعيش تجربة التراث بشكل لم تختبره من قبل.",
    "era_tent": "منذ آلاف السنين",
    "region_tent": "شبه الجزيرة العربية",
    "era_dallah": "القرن التاسع الهجري",
    "region_dallah": "نجد والحجاز",
    "era_sword": "العصر الإسلامي",
    "region_sword": "الجزيرة العربية",
    "era_mubkhara": "قديم قِدَم الحضارة",
    "region_mubkhara": "الخليج العربي",
    "label_era": "الحقبة",
    "label_region": "المنطقة",
    "delete_last": "حذف آخر مجسم",
    "no_models_placed": "لم يُوضع أي مجسم بعد",
    "collection_saved": "✓ تم حفظ تقدمك",
  ...
  en: {
    ...
    "culture_heading": "Our Heritage, Our Identity",
    "culture_body": "The Arabian Peninsula holds a rich civilizational legacy spanning thousands of years. These artifacts are not mere tools — they are living symbols that tell the story of the Saudi people: their generosity, courage, and deep connection to their land. Through this tour, you will explore four heritage artifacts in augmented reality and experience culture like never before.",
    "era_tent": "Thousands of years ago",
    "region_tent": "Arabian Peninsula",
    "era_dallah": "9th Hijri Century",
    "region_dallah": "Najd & Hijaz",
    "era_sword": "Islamic Era",
    "region_sword": "Arabian Peninsula",
    "era_mubkhara": "Ancient Civilization",
    "region_mubkhara": "Arabian Gulf",
    "label_era": "Era",
    "label_region": "Region",
    "delete_last": "Delete Last Model",
    "no_models_placed": "No model placed yet",
    "collection_saved": "✓ Progress Saved",
